...
<div style="max-width:520px;margin:0 auto;background:#0F1E35;border:1px solid rgba(245,158,11,.2);border-radius:16px;overflow:hidden">
  ...
  <div style="padding:32px">
    ...
    <a href="https://factucon.do/portal/dashboard" style="display:inline-block;background:#F59E0B;color:#fff;font-weight:700;font-size:14px;padding:12px 24px;border-radius:10px;text-decoration:none">
      Pagar ahora →
    </a>
  </div>
</div>
